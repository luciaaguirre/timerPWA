...
class TimerComponent extends lit__WEBPACK_IMPORTED_MODULE_0__.LitElement {
  ...
  render() {
    return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)` ${this._timerTemplate()} `;
  }
  get isFinished() {
  ...
  _joinTemplate() {
    return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)` <span class="timer-component_join">${this.join}</span> `;
  }
  _timerTemplate() {
    ...
    const template = (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`${time.map((value, index) => (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
        <time-part-component
          value="${value}"
  ...
  render() {
    return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
      ...
      <div class="timer-player-component__actions">
        ${this.pauseBtn ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<button
              class="timer-player-component__actions--pause"
              @click="${this.pause}"
            >
              Pause
            </button>` : ''}
        ${this.playBtn ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<button
              class="timer-player-component__actions--play"
              @click="${this.play}"
            >
              Play
            </button>` : ''}
        ${this.resetBtn ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<button
