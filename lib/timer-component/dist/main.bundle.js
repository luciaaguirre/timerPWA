...
/* harmony import */ var _TimerPartComponent_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./TimerPartComponent.js */ "./src/TimerPartComponent.js");
...
class TimerComponent extends lit__WEBPACK_IMPORTED_MODULE_0__.LitElement {
  constructor() {
    super();
    this.start = 0;
    this.reverse = false;
  ...
  render() {
    return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)(_templateObject || (_templateObject = _taggedTemplateLiteral([" ", " "])), this._timerTemplate());
  }
  get isFinished() {
  ...
  _joinTemplate() {
    return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral([" <span class=\"timer-component_join\">", "</span> "])), this.join);
  }
  _timerTemplate() {
    var formatArr = this.format.split(':');
    var time = formatArr.map(part => {
      if (part.includes('H')) return this._hours;
      if (part.includes('M')) return this._minutes;
      if (part.includes('S')) return this._seconds;
    });
    var template = (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["", ""])), time.map((value, index) => (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n        <time-part-component\n          value=\"", "\"\n          format=\"", "\"\n        ></time-part-component>\n        ", "\n      "])), value, formatArr[index], index < time.length - 1 ? this._joinTemplate() : '')));
    return template;
  }
  _setTime() {
    var seconds = this._secondsCount % 60;
    var minutes = Math.floor(this._secondsCount / 60) % 60;
    var hours = Math.floor(this._secondsCount / 3600);
...
_defineProperty(TimerComponent, "properties", {
  _seconds: {
    type: Number,
    state: true
  },
...
_defineProperty(TimerComponent, "styles", (0,lit__WEBPACK_IMPORTED_MODULE_0__.css)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n    :host {\n      display: flex;\n      justify-content: center;\n      align-items: center;\n    }\n  "]))));
window.customElements.define('timer-component', TimerComponent);

/***/ }),

/***/ "./src/TimerPartComponent.js":
/*!***********************************!*\
  !*** ./src/TimerPartComponent.js ***!
  \***********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class TimerPartComponent extends lit__WEBPACK_IMPORTED_MODULE_0__.LitElement {
  constructor() {
    super();
  }
  render() {
    return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <div class=\"time-part-component\">", "</div>\n    "])), this._formatTime(this.value));
  }
  _formatTime(time) {
    var _this$format;
    if (((_this$format = this.format) === null || _this$format === void 0 ? void 0 : _this$format.length) > 1) return time < 10 ? "0".concat(time) : time;
    return time;
  }
}
_defineProperty(TimerPartComponent, "properties", {
  value: {
    type: Number,
    attribute: true
  },
...
_defineProperty(TimerPartComponent, "styles", (0,lit__WEBPACK_IMPORTED_MODULE_0__.css)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n    :host {\n      color: var(--timer-component-part-color);\n      background-color: var(--text-color);\n      padding: 0.5rem;\n      box-shadow: 5px 5px 10px grey;\n      border-radius: 0.5rem;\n      margin: 0.5rem;\n    }\n  "]))));
window.customElements.define('time-part-component', TimerPartComponent);

/***/ }),

/***/ "./src/TimerPlayerComponent.js":
/*!*************************************!*\
  !*** ./src/TimerPlayerComponent.js ***!
  \*************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var lit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lit */ "./node_modules/lit/index.js");
/* harmony import */ var _TimerComponent_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./TimerComponent.js */ "./src/TimerComponent.js");
var _templateObject, _templateObject2, _templateObject3, _templateObject4, _templateObject5;
function _taggedTemplateLiteral(e, t) { return t || (t = e.slice(0)), Object.freeze(Object.defineProperties(e, { raw: { value: Object.freeze(t) } })); }
function _defineProperty(e, r, t) { return (r = _toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
function _toPropertyKey(t) { var i = _toPrimitive(t, "string"); return "symbol" == typeof i ? i : i + ""; }
...
class TimerPlayerComponent extends lit__WEBPACK_IMPORTED_MODULE_0__.LitElement {
  constructor() {
    super();
    this.playBtn = false;
    this.pauseBtn = false;
  ...
  render() {
    return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <div class=\"timer-player-component__status\">", "</div>\n      <slot></slot>\n      <div class=\"timer-player-component__actions\">\n        ", "\n        ", "\n        ", "\n      </div>\n    "])), this._status, this.pauseBtn ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["<button\n              class=\"timer-player-component__actions--pause\"\n              @click=\"", "\"\n            >\n              Pause\n            </button>"])), this.pause) : '', this.playBtn ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["<button\n              class=\"timer-player-component__actions--play\"\n              @click=\"", "\"\n            >\n              Play\n            </button>"])), this.play) : '', this.resetBtn ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["<button\n              class=\"timer-player-component__actions--reset\"\n              @click=\"", "\"\n            >\n              Reset\n            </button>"])), this.reset) : '');
  }
  play() {
...
_defineProperty(TimerPlayerComponent, "properties", {
  playBtn: {
    type: Boolean,
    attribute: 'play-btn'
  },
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   TimerComponent: () => (/* reexport safe */ _TimerComponent_js__WEBPACK_IMPORTED_MODULE_0__.TimerComponent),
/* harmony export */   TimerPartComponent: () => (/* reexport safe */ _TimerPartComponent_js__WEBPACK_IMPORTED_MODULE_1__.TimerPartComponent),
/* harmony export */   TimerPlayerComponent: () => (/* reexport safe */ _TimerPlayerComponent_js__WEBPACK_IMPORTED_MODULE_2__.TimerPlayerComponent)
/* harmony export */ });
/* harmony import */ var _TimerComponent_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./TimerComponent.js */ "./src/TimerComponent.js");
/* harmony import */ var _TimerPartComponent_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./TimerPartComponent.js */ "./src/TimerPartComponent.js");
/* harmony import */ var _TimerPlayerComponent_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./TimerPlayerComponent.js */ "./src/TimerPlayerComponent.js");
